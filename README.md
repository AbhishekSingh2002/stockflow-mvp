...
| PUT    | /api/settings  | organization settings data | Admin only |
...
3. **Configure**: Create backend/.env with database URL and JWT secret
...
- **Real-time updates** - Financial data reflects immediately
